 ...
 // view
    ...
    function ClockViewDOM() {
        ...
        //Контейнер, большой круг часов
            ...
            bigClock.style.backgroundColor='yellow';
        ...
        //Маленькие круги и цифры
            ...
            for(var i=1;i<=12;i++){
                ...
                smallCircles[i].style.fontSize=smallCircles[i].offsetWidth/2+'px';
        ...
        //Стрелки
            ...
            strBigClock.style.backgroundColor='black';
            ...
            strMdlClock.style.backgroundColor='black'; 
            ...
            strSmClock.style.backgroundColor='black';
